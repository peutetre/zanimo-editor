...
var Q = require('q'),
    ...
    isWPCordova = require('./$').isWPCordova,
    env = require('../env'),
...
user.authenticate = function () {
    ...
    if(window.cordova) {
        var cboptions = isWPCordova ? 'location=no' : 'location=no,closebuttoncaption=Cancel,clearcache=yes,clearsessioncache=yes';
        var childbrowser = window.open(ghoauth, '_blank', cboptions);
        childbrowser.clear();
