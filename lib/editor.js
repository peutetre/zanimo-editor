...
var Zanimo = require('zanimo'),
    ...
    emptyScript = require('./data/demos/empty').toString(),
...
editor.init = function () {
    ...
    emptyScript = emptyScript.substring(emptyScript.indexOf("{") + 1, emptyScript.lastIndexOf("}"));
    aboutContentHTML = $.$("#about-content").innerHTML;
    ...
    if($.isTouchable) {
        ...
        $playBtn.addEventListener("click", editor.onPlay);
        $saveBtn.addEventListener("click", editor.onSave);
        $trashBtn.addEventListener("click", editor.onTrash);
        $signBtn.addEventListener( "click", editor.onSign);
        $logoutBtn.addEventListener("click", editor.onLogout);
        $shareBtn.addEventListener("click", editor.onShare);
    }
