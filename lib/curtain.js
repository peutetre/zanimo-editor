...
var state = false,
    $documentation,
    $activeArea,
    openedLenght = function (h) {
        return "translate3d(0, -" + (h - 80) + "px,0)";
    },
    hiddenLenght = function (h) {
        return "translate3d(0, -" + (h - 30) + "px,0)";
    },
    open = function (elt) {
        return _$.getViewportHeight().then(function (h) {
            return Zanimo(elt, "transform", openedLenght(h), 400, "ease-in-out");
        });
    },
    hide = function (elt) {
        return _$.getViewportHeight().then(function (h) {
            return Zanimo(elt, "transform", hiddenLenght(h), 400, "ease-in-out");
        });
    },
